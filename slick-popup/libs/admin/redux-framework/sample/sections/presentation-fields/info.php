...
Redux::set_section(
	...
	array(
		...
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'your-textdomain-here' ) . '<a href="//docs.redux.io/core/fields/info/" target="_blank">docs.redux.io/core/fields/info/</a>',
		'subsection' => true,
		'fields'     => array(
			array(
				'id'   => 'opt-info-field',
