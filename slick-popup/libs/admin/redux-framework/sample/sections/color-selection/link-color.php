...
Redux::set_section(
	...
	array(
		...
		'desc'       => esc_html__( 'For full documentation on this field, visit: ', 'your-textdomain-here' ) . '<a href="//docs.redux.io/core/fields/link-color/" target="_blank">docs.redux.io/core/fields/link-color/</a>',
		'id'         => 'color-link',
		'subsection' => true,
		'fields'     => array(
			array(
